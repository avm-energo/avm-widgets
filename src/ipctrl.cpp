...
{
    for (unsigned int i = 0; i != NET_IP_SIZE; ++i)
    {
...
void IPCtrl::setIP(const NetIP ipAddr)
{
    for (auto i = 0; i != NET_IP_SIZE; ++i)
    {
